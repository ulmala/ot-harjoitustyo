...
point_checker.dispatcher[6]('player' , 's')

print(point_checker.dispatcher[7](list(range(1,6))))

#for (i, func) in zip(range(0, 14), point_checker.dispatcher):
    #print(i, func([1,2,3,4,5]))
