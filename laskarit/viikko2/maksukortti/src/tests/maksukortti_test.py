...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_negatiivinen_lataus_ei_muut_saldoa(self):
        self.kortti.lataa_rahaa(-1)
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 10 euroa")

    def test_edullisen_lounaan_ostaminen_tasarahalla_onnistuu(self):
        self.kortti = Maksukortti(2.5)
        self.kortti.syo_edullisesti()
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 0.0 euroa")

    def test_maukkaan_lounaan_ostaminen_tasarahalla_onnistuu(self):
